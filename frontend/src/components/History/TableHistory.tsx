...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/history/historySlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureHistoryCols';
...
const TableSampleHistory = ({
  ...
  useEffect(() => {
    if (historyNotify.showNotification) {
      notify(historyNotify.typeNotification, historyNotify.textNotification);
    }
  }, [historyNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/history/history-view/?id=${id}`);
  };
