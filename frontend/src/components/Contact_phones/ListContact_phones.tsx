            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/contact_phones/contact_phones-edit/?id=${item.id}`}
                  pathView={`/contact_phones/contact_phones-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && contact_phones.length === 0 && (
...
export default ListContact_phones;
