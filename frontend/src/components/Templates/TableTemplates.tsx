...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/templates/templatesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureTemplatesCols';
...
const TableSampleTemplates = ({
  ...
  useEffect(() => {
    if (templatesNotify.showNotification) {
      notify(
        templatesNotify.typeNotification,
        templatesNotify.textNotification,
      );
    }
  }, [templatesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/templates/templates-view/?id=${id}`);
  };
...
export default TableSampleTemplates;
