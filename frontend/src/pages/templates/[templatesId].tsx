...
const EditTemplates = () => {
  ...
  const { templatesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: templatesId }));
  }, [templatesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: templatesId, data }));
...
EditTemplates.getLayout = function getLayout(page: ReactElement) {
  return (
