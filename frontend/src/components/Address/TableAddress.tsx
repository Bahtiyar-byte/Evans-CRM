...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/address/addressSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureAddressCols';
...
const TableSampleAddress = ({
  ...
  useEffect(() => {
    if (addressNotify.showNotification) {
      notify(addressNotify.typeNotification, addressNotify.textNotification);
    }
  }, [addressNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/address/address-view/?id=${id}`);
  };
...
export default TableSampleAddress;
