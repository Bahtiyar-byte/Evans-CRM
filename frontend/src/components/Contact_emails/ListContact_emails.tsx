            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/contact_emails/contact_emails-edit/?id=${item.id}`}
                  pathView={`/contact_emails/contact_emails-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && contact_emails.length === 0 && (
...
export default ListContact_emails;
