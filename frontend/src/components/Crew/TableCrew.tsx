...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/crew/crewSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureCrewCols';
...
const TableSampleCrew = ({
  ...
  useEffect(() => {
    if (crewNotify.showNotification) {
      notify(crewNotify.typeNotification, crewNotify.textNotification);
    }
  }, [crewNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/crew/crew-view/?id=${id}`);
  };
...
export default TableSampleCrew;
