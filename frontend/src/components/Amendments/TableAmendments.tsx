...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/amendments/amendmentsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureAmendmentsCols';
...
const TableSampleAmendments = ({
  ...
  useEffect(() => {
    if (amendmentsNotify.showNotification) {
      notify(
        amendmentsNotify.typeNotification,
        amendmentsNotify.textNotification,
      );
    }
  }, [amendmentsNotify.showNotification]);
  ...
  const handleEditAction = (id: string) => {
    router.push(`/amendments/${id}`);
  };

  const handleViewAction = (id: string) => {
    router.push(`/amendments/amendments-view/?id=${id}`);
  };
...
export default TableSampleAmendments;
