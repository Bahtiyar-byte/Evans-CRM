...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/contracts/contractsSlice';
...
const TableSampleContracts = ({
  ...
  useEffect(() => {
    if (contractsNotify.showNotification) {
      notify(
        contractsNotify.typeNotification,
        contractsNotify.textNotification,
      );
    }
  ...
  const handleViewAction = (id: string) => {
    router.push(`/contracts/contracts-view/?id=${id}`);
  };
