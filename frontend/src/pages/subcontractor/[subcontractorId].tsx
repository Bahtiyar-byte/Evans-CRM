...
const EditSubcontractor = () => {
  ...
  const { subcontractorId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: subcontractorId }));
  }, [subcontractorId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: subcontractorId, data }));
...
EditSubcontractor.getLayout = function getLayout(page: ReactElement) {
  return (
