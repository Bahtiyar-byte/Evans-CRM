...
const EditContact_phones = () => {
  ...
  const { contact_phonesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: contact_phonesId }));
  }, [contact_phonesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: contact_phonesId, data }));
...
EditContact_phones.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditContact_phones;
